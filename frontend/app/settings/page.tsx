    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Connected via MCP - Auto-synced daily</p>
            </div>
            <span className="text-xs bg-green-100 text-green-700 px-2 py-1 rounded">Connected</span>
          </div>
        </div>
      ...
      <div className="bg-blue-50 rounded-lg border border-blue-200 p-6">
        ...
        <p className="text-sm text-blue-800 mb-3">
          Your BI system automatically combines data from both Zoho Books and QuickBooks via scheduled MCP syncs to provide comprehensive insights.
        </p>
        <ul className="text-sm text-blue-800 space-y-1">
          ...
          <li>✓ Daily QuickBooks sync via MCP server</li>
          <li>✓ Hourly Zoho Books delta syncing</li>
        </ul>
      </div>
    </div>
  );
